...
import (
	...
	"github.com/zntrio/mitre/cvss/v2/score"
)

var (
	cmpOpts = []cmp.Option{
		cmpopts.IgnoreUnexported(cvssv2.Vector{}),
		cmpopts.IgnoreUnexported(cvssv2.BaseMetrics{}),
		cmpopts.IgnoreUnexported(cvssv2.TemporalMetrics{}),
		cmpopts.IgnoreUnexported(cvssv2.EnvironmentalMetrics{}),
		cmpopts.IgnoreUnexported(cvssv2.Score{}),
		cmpopts.IgnoreUnexported(cvssv2.BaseScore{}),
		cmpopts.IgnoreUnexported(cvssv2.EnvironmentalScore{}),
		cmpopts.IgnoreUnexported(cvssv2.TemporalScore{}),
	}
)
